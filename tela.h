...
*/
	...
	/* PLACAR */
		...
		#define POSICAO_PLACAR_LINHA ESPESSURA_BORDA_TELA + 1
		#define POSICAO_PLACAR_COLUNA ESPESSURA_BORDA_TELA + 1
	
	/* CARRO */
		#define POSICAO_CARRO_LINHA (TAMANHO_TELA_LINHAS - ESPESSURA_BORDA_TELA - TAMANHO_CARRO_LINHAS)
		#define POSICAO_CARRO_COLUNA ((TAMANHO_TELA_COLUNAS / 2) - (TAMANHO_CARRO_COLUNAS / 2))
